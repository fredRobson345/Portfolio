...
"violet","awesome", "bicycle", "chicken", "dolphin", "elephant",
 ...
 "technology", "abundance", "basketball", "celebration",
 "destination", "examination", "friendship", "highlighter",
 "investment", "journalist", "kaleidoscope", "labyrinth",
 "magnificent", "narrative", "overwhelm", "persuasion",
 "quarantine", "recognition", "spectacular", "transition",
 "university"};
    ...
    public Hangmanm10() {
        ...
        triesLeft = 6; // You can change the number of tries as needed
