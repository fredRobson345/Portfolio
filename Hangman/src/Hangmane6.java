...
"violet"};
    ...
    public Hangmane6() { //the class called from Easy6 jFrame
    ...
    /*when the user makes a guess it goes through each letter in the word and compares the two
    and will return true or false depending on if the letter is in the word*/
    ...
    //declaring the differnet classes that can be called
    ...
    /*reset class that will reset the game and choose a new word once the word is guessed or
